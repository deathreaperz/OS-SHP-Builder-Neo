...
uses
   Windows, BasicDataTypes, SHP_File, Palette, ExtCtrls, Classes, Graphics, SHP_Shadows, SysUtils, Math;
...
var
   temp: char8;
begin
   temp   := char8((GetBValue(colour) * 29 + GetGValue(colour) * 150 + GetRValue(colour) * 77) div 256);
