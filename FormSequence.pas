...
uses
  ...
  Dialogs, StdCtrls, ComCtrls, ExtCtrls, Menus, Spin, BasicDataTypes, shp_file,
  Shp_Engine,Shp_Image, palette, ExtDlgs, SHP_Image_Save_Load,SHP_Sequence_Animation,
  SHP_DataMatrix, OSExtDlgs, FormGifOptions, XPMan;
