...
uses BasicDataTypes, BasicMathsTypes, SysUtils, Classes, Math, Windows, Graphics, ShellAPI;
...
begin
   ...
   try
      ...
      begin
        _Stream.WriteBuffer(_String[MyChar],sizeof(char8));
      end;
      _Stream.WriteBuffer(Zero,sizeof(Char8));
   except
      exit;
   end;
   Result := true;
...
begin
   Result := '';
   try
      _Stream.ReadBuffer(MyChar,sizeof(Char8));
      while MyChar <> #0 do
      begin
