...
var
   i: integer;
   Buffer: array[0..254] of char8;
begin
   BlockRead(_F,Buffer,255 * Sizeof(char8));
   i := 0;
   Result := '';
   while Buffer[i] <> #0 do
   begin
...
begin
   ...
   BlockWrite(_F,Buffer,255 * Sizeof(char8));
end;
