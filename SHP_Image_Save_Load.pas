...
uses
   Graphics, Jpeg, PCXCtrl, SysUtils, {$IF CompilerVersion > 28}Vcl.Imaging.GIFImg {$ELSE} GIFImage{$ENDIF}, {$IF CompilerVersion > 28}Vcl.Imaging.pngimage {$ELSE} PngImage{$ENDIF}, TARGA, Dialogs, SHP_File,
