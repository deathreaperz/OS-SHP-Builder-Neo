...
uses
   ...
   Dialogs, ExtCtrls, StdCtrls, ImgList, palette, SHP_Cameo, Spin, BasicDataTypes,
   SHP_file, jpeg, undo_redo, SHP_DataMatrix, ExtDlgs, SHP_Image_Save_Load,
   Colour_list, SHP_Engine_CCMs, SHP_Engine_Resize, FormPaletteSelection, Math,
   ComCtrls, SHP_ENGINE, SHP_IMAGE, SHP_Colour_Bank, OSExtDlgs, XPMan, System.ImageList;
